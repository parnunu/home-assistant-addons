...
| Lightweight Forward Proxy | `lightweight_forward_proxy` | `lightweight_forward_proxy` | `https://github.com/parnunu/ha-addon-web-proxy` | Lightweight tinyproxy-based HTTP/HTTPS forward proxy |
